...
if __name__ == '__main__':
    ...
    mal_case_dir = '/mnt/hard_disk/samples/groundtruth/'  # malicious case dir
    ben_case_dir = '/mnt/hard_disk/samples/benign_sample/' # benign case dir
    bin_model_name = "judge/models/bin_model_xxii"
    mul_model_name = "judge/models/mul_model_viii"
    ...
    if os.path.isdir(bin_fname):
        ...
        bin_model = train_bin(benign_category + malicious_category, mal_case_dir,ben_case_dir, 5000, epochs, bin_model_name, max_features, embedding_dims, batch_size)
    ...
    # predict
    # 这个目录是做什么用的?
    # Q之前的预处理 得到了和ID关联的一个int类型的数组
    debug_png_dir = '/mnt/hard_disk/new/crawler/crawler_result/'  # path to save the screenshot of websites for debug
    ...
    while True:
        ...
        mul_num = predict(True, bin_model, predict_category, ml_maxlen, debug_png_dir, predict_batch_size)
